...
import mygroup.dto.EmailCodeSendDTO;
...
public class EmailController {
	...
	public RestData<String> sendVerificationCode(@RequestBody EmailCodeSendDTO emailCodeSendDTO) {
		emailService.sendVerificationCode(emailCodeSendDTO.getEmail());
