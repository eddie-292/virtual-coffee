...
/**
 * @description:邀请码表：invitation_codes表的持久类
 * @author Eddie
 * @date 2024-02-07
 */
@Data
@TableName("invitation_codes")
@ApiModel(value = "InvitationCodes对象", description = "邀请码")
public class InvitationCodes implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty("邀请码")
    @TableId("invitation_code")
    ...
    @ApiModelProperty("生产者用户ID")
    @TableField("producer_user_id")
    @JsonSerialize(using = ToStringSerializer.class)
