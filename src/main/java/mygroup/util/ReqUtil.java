...
public class ReqUtil {
    ...
    public static String id(HttpServletRequest request) {
        if (null == request) {
            ...
            Object reqId = request.getHeader("Request-Sequence");
            return reqId == null ? null : reqId.toString();
        }
    }

    //get blacklist Key
    public static String getBlacklistKey(String ip, String uri) {
        return "blacklist:" + ip + ":" + uri;
    }

    //get punish key
    public static String getPunishKey(String ip) {
        return "punish:" + ip;
    }
}
